...
## 🌟 최신 기능 (v6.0 하이브리드 AI 판단 시스템) ⭐⭐⭐ NEW

### 🧠 **하이브리드 AI 판단 시스템** ⭐⭐⭐ NEW v6.0
이미지와 키워드가 안 맞아도 자연스러운 콘텐츠 생성!
...
## 마지막 업데이트
- **버전**: v6.0 하이브리드 AI 판단 시스템
- **날짜**: 2025-12-28
- **변경사항**: 
  - **하이브리드 AI 판단 시스템 추가** ⭐⭐⭐
    - 이미지-키워드 매칭 분석 (0-100점 자동 평가)
    - 3가지 전략 자동 선택 (통합형/이미지중심/키워드중심)
    - 전략별 프롬프트 생성 로직 구현
    - 일치도 30점 미만 시 사용자 경고 시스템
    - 자연스러운 콘텐츠 생성 보장
  - v5.3 기능 유지:
    - 배치 생성 기능 (이미지 100장/200MB)
