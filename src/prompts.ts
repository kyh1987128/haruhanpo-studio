...
⚠️ **중요: 반드시 제공된 이미지 분석 내용을 기반으로 콘텐츠를 작성하세요. 이미지와 무관한 내용은 절대 작성하지 마세요.**
...
⚠️ 이미지 분석 결과를 반드시 본문 내용에 구체적으로 반영하세요. 이미지에 나타난 제품, 장소, 분위기, 색상 등을 정확하게 언급하고 설명해야 합니다.
...
⚠️ **중요: 반드시 제공된 이미지 분석 내용을 기반으로 캡션을 작성하세요. 이미지와 무관한 내용은 절대 작성하지 마세요.**
...
⚠️ 캡션은 이미지에 실제로 담긴 내용(제품, 장소, 사람, 분위기 등)을 직접적으로 언급하고 묘사해야 합니다.
...
⚠️ **중요: 반드시 제공된 이미지 분석 내용을 기반으로 텍스트를 작성하세요. 이미지와 무관한 내용은 절대 작성하지 마세요.**
...
⚠️ 포스트 내용은 이미지에 실제로 담긴 내용을 구체적으로 언급해야 합니다.
...
⚠️ **중요: 반드시 제공된 이미지 분석 내용을 기반으로 스크립트를 작성하세요. 이미지와 무관한 내용은 절대 작성하지 마세요.**
...
⚠️ 스크립트는 이미지에 실제로 담긴 장면, 제품, 분위기를 구체적으로 설명하고 언급해야 합니다.
