...
<body class="bg-gray-50" data-page="youtube-analyzer">
    ...
    <div class="three-column-layout">
      ...
      <aside class="filter-sidebar">
        <div class="p-4">
          ...
          <!-- 검색 버튼 -->
          <button id="market-search-btn" class="w-full flex items-center justify-between px-4 py-3 bg-gradient-to-r from-violet-500 to-indigo-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 font-semibold">
          ...
          <div class="bg-white rounded-xl shadow-sm border p-6">
            ...
            <div id="trendLoadArea" class="flex flex-col items-center justify-center py-16">
              ...
              <button id="trendLoadBtn" onclick="loadTrendWithCredit()"
                class="w-full max-w-xs flex items-center justify-between px-4 py-3 bg-gradient-to-r from-orange-500 to-rose-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 font-semibold">
                <span class="flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
              ...
              <div class="flex gap-3">
                ...
                <button 
                  ...
                  class="flex items-center justify-between gap-3 px-4 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 font-semibold"
                >
                  <span class="flex items-center gap-2">
  ...
  <script src="/static/youtube-finder.js?v=8.6.1"></script>
  
  <!-- Phase 2.5: Trends Insights (Supabase 연동) -->
  <script src="/static/youtube-trends.js?v=8.6.1"></script>
