                ...
                <div class="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl border-2 border-blue-200">
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-bold text-gray-800 mb-1">
                                📁 파일 업로드 
                                <span class="ml-2 text-xs bg-blue-600 text-white px-2 py-1 rounded-full">NEW v7.0</span>
                            </h3>
                            <p class="text-sm text-gray-600">
                                이미지와 문서를 업로드하여 더 풍부한 콘텐츠를 생성하세요
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block mb-2 font-semibold text-gray-700">
                            <i class="fas fa-images mr-2"></i>이미지 업로드 (최대 5장)
                        </label>
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition cursor-pointer bg-white"
                             onclick="document.getElementById('imageFiles').click()">
                            <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-3"></i>
                            <p class="text-gray-600 font-medium mb-1">클릭하거나 이미지를 드래그하세요</p>
                            <p class="text-sm text-gray-500">JPG, PNG, WebP, GIF (최대 10MB)</p>
                        </div>
                        <input
                            type="file"
                            id="imageFiles"
                        ...
                        />
                        <div id="imagePreviewGrid" class="mt-3 grid grid-cols-5 gap-2"></div>
                    ...
                    <div>
                        <label class="block mb-2 font-semibold text-gray-700">
                            <i class="fas fa-file-alt mr-2"></i>문서 업로드 (최대 3개, 선택사항)
                        </label>
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-400 transition cursor-pointer bg-white"
                            ...
                            <p class="text-gray-600 font-medium mb-1">클릭하거나 문서를 드래그하세요</p>
                            <p class="text-sm text-gray-500">PDF, DOCX, TXT (최대 10MB)</p>
                        </div>
                        <input
                            type="file"
                            id="documentFiles"
                        ...
                        <div class="mt-3 p-3 bg-blue-50 border-l-4 border-blue-500 rounded">
                            <p class="text-xs text-gray-700 leading-relaxed">
                                ...
                                • 시나리오1 (이미지만): ₩92/회 - 시각적 콘텐츠 중심<br>
                                • 시나리오2 (문서만): ₩40/회 - 팩트 기반 콘텐츠 (절감형) ⭐<br>
                                • 시나리오3 (이미지+문서): ₩105/회 - 통합 프리미엄 콘텐츠
                            </p>
                        </div>
                    </div>
                </div>
