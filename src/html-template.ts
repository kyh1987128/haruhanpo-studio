...
<head>
    ...
    <link href="/static/styles.css?v=8.1.0" rel="stylesheet">
...
<body class="bg-gradient-to-br from-purple-50 to-blue-50 min-h-screen" data-page="postflow">
    ...
    <div class="mx-4 px-0 py-4 layout-container" style="margin-top: 5.5rem;">
        ...
        <!-- ========================================
             이미지 편집 섹션 (메인 콘텐츠 영역)
             ======================================== -->
        <div id="imageEditorSection" class="bg-white rounded-2xl shadow-lg border p-4 mb-6 mx-0">
    ...
    <script src="/static/keyword-analysis.js?v=8.1.0"></script>
    <script src="/static/keyword-extended.js?v=8.1.0"></script>
    
    <!-- 온보딩 시스템 로드 -->
    <script src="/static/onboarding-integration.js?v=8.1.0"></script>
    
    <!-- 스마트 추천 시스템 로드 -->
    <script src="/static/smart-recommendations.js?v=8.1.0"></script>
    
    <!-- 자동 저장 및 이어서 작업하기 시스템 로드 -->
    <script src="/static/auto-save.js?v=8.1.0"></script>
    ...
    <!-- 이미지 도구 모듈 -->
    <script src="/static/indexeddb-helper.js?v=8.1.0"></script>
    <script src="/static/image-search.js?v=8.1.0"></script>
    <script src="/static/image-generator.js?v=8.1.0"></script>
    <script src="/static/image-editor.js?v=8.1.0"></script>
    <script src="/static/thumbnail-generator.js?v=8.1.0"></script>
    <script src="/static/image-editor-section.js?v=8.1.0"></script>
    <script src="/static/slide-collection.js?v=8.1.0"></script>
    <script src="/static/card-news-templates.js?v=8.1.0"></script>
    <script src="/static/card-news-generator.js?v=8.1.0"></script>
    <script src="/static/design-feedback.js?v=8.1.0"></script>
