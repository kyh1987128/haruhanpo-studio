...
<body class="bg-gradient-to-br from-purple-50 to-blue-50 min-h-screen" data-page="postflow">
    ...
    <script src="/static/app-v3-final.js?v=8.3.0"></script>
    <script src="/static/keyword-analysis.js?v=8.3.0"></script>
    <script src="/static/keyword-extended.js?v=8.3.0"></script>
    ...
    <script src="/static/auto-save.js?v=8.3.0"></script>
    ...
    <!-- 이미지 도구 모듈 -->
    <script src="/static/indexeddb-helper.js?v=8.3.0"></script>
    ...
    <script src="/static/card-news-generator.js?v=8.3.0"></script>
